...
**Domain split (decided 2026-09-03):** `theohermann.ch` (bought 2026-09-03, not yet delegated) will become the sharp, client-facing robotics-consulting landing; `theoalessandro.com` becomes the personal site bridging all professional axes plus experimentation. Cycle 7 still lands here as the seed material for the .ch site; from cycle 8 the consulting funnel moves to .ch and this site re-widens.
