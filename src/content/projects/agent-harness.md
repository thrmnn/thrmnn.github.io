...
label: "Open-source · in daily use at MIT Senseable Rio"
featuredOrder: 1
...
Author of [agent-harness](https://github.com/thrmnn/agent-harness) — open-source typed tool layer + regression evals for agentic systems. Daily driver of multi-agent orchestration for research tooling at MIT Senseable Rio.
