export const author = {
  ...
  experience: [
    {
      role: 'Research Fellow — Tech Lead',
      company: 'MIT Senseable City Lab',
      url: 'https://senseablerio.mit.edu/',
      period: 'Jan 2025 – Present',
      location: 'Rio de Janeiro, Brazil',
      summary:
        'Leading 10-person interdisciplinary team building high-fidelity 3D digital twins of Rio\'s favelas from terrestrial LiDAR, aerial imagery, and terrain data. Reconstructions feed OpenFOAM CFD simulations of airborne disease transmission. Tech: Python, Blender, GeoPandas, Google Earth Engine.',
    },
    {
